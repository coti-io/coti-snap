...
const ContentErrorText = styled.p`
  font-size: ${(props) => props.theme.fontSizes.small};
  font-weight: medium;
  margin: 0;
...
const EditableInput = styled.input<{ $isEditable: boolean }>`
  border: none;
  outline: none;
  font-size: 14px;
  background-color: ${(props) => props.theme.colors.background?.default};
...
const OnboardingAccount = () => (
  ...
  >
    ...
    <ContentText>Onboarding account</ContentText>
  </div>
);

export const OnboardAccountWizzard = () => {
  const [isOnboarding] = useState(true);
  ...
  return (
    <>
      ...
      <ContentInput>
        ...
        <EditableInputContainer $isEditable={isEditable} $isError={isError}>
          <EditableInput
            type="text"
            value={value}
          ...
          <EditIcon onClick={handleIconClick}>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_573_215)">
                <path d="M3.5 17.2501V21.0001H7.25L18.31 9.94006L14.56 6.19006L3.5 17.2501ZM21.21 7.04006C21.3962 6.8527 21.5008 6.59925 21.5008 6.33506C21.5008 6.07087 21.3962 5.81742 21.21 5.63006L18.87 3.29006C18.6826 3.10381 18.4292 2.99927 18.165 2.99927C17.9008 2.99927 17.6474 3.10381 17.46 3.29006L15.63 5.12006L19.38 8.87006L21.21 7.04006Z" />
              </g>
              <defs>
                <clipPath id="clip0_573_215">
                  <rect
                    width="24"
                    height="24"
                    fill="white"
      ...
      <ContentButtons>
        <Button text="Cancel" fullWith={true} />
        <Button primary text="Onboard" fullWith={true} />
      </ContentButtons>
      {isError && <ContentErrorText>Error to onboard account</ContentErrorText>}
    </>
  );
};
